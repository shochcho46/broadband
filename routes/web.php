...
Route::get('/', [App\Http\Controllers\HomeController::class, 'home'])->name('home')->middleware('visitor');
Route::get('/config', [App\Http\Controllers\HomeController::class, 'artisanCmd']);
