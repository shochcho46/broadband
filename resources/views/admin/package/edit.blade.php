                        ...
                        <form action="{{ route('admin-package.update',$data->id) }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="card-body" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"  name="amount" class="form-control" id="amount" value="{{$data->amount}}" required>
                                    @error('amount')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3" data-repeater-list="group_option">
                                    ...
                                    @forelse ($data->packageDetail as $optValue)
                                        <div data-repeater-item class="d-flex align-items-center mb-2">
                                            <input type="text" class="form-control me-2" id="option" name="option" value="{{$optValue->title}}" required>
